...
import { Dashboard, IDashboardEmbedConfiguration } from 'powerbi-client';
...
export declare class PowerBIDashboardEmbedComponent extends PowerBIEmbedComponent implements OnInit, OnChanges, AfterViewInit {
     ...
     * @returns void
     */
    private embedOrUpdateDashboard;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PowerBIDashboardEmbedComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<PowerBIDashboardEmbedComponent, "powerbi-dashboard[embedConfig]", never, { "embedConfig": "embedConfig"; "eventHandlers": "eventHandlers"; }, {}, never, never, false>;
}

//# sourceMappingURL=powerbi-dashboard-embed.component.d.ts.map